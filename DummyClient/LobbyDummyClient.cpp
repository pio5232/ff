...
void jh_content::LobbyDummyClient::OnRecv(ULONGLONG sessionId, PacketBufferRef packet, USHORT type)
{
...
void jh_content::LobbyDummyClient::OnDisconnected(ULONGLONG sessionId)
{
	...
	SessionConnectionEventRef sessionConnEvent = jh_memory::MakeShared<jh_utility::SessionConnectionEvent>(sessionId, jh_utility::SessionConnectionEventType::DISCONNECT);// MakeSystemJob(sessionId, jh_utility::SessionConnectionEventType::CONNECT);
