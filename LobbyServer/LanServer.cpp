...
void jh_content::LobbyLanServer::OnRecv(ULONGLONG sessionId, PacketBufferRef packet, USHORT type)
{
	JobRef jobPtr = jh_memory::MakeShared<jh_utility::Job>(sessionId, type, packet); // MakeJob(sessionId, type, packet);
