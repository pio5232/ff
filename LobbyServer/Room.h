...
namespace jh_content
{
	...
	public:
		...
		void BroadCast(PacketBufferRef& packet, ULONGLONG excludedId = 0); // 패킷, 방번호, 제외할 UserID (없으면 0)
		void Unicast(PacketBufferRef& packet, ULONGLONG sessionId);
	...
	private:
		static alignas(32) volatile LONG								aliveRoomCount;
