...
void jh_content::GameLanClient::OnRecv(ULONGLONG sessionId, PacketRef packet, USHORT type)
{
...
void jh_content::GameLanClient::OnConnected(ULONGLONG sessionId)
{
	...
	PacketRef settingReqPkt = jh_content::PacketBuilder::BuildGameServerSettingRequestPacket();
